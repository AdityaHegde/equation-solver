...
module.exports = function(termHeap, termRef, termsMeta, parentTerm) {
  for(var i = 0; i < this.terms.length; i++) {
    this.terms[i].processForFactorization(termHeap, termRef, termsMeta, this);
  }
  ...
  for(var i = 0; i < pts.length; i++) {
    ...
    terms = [],
    //sum of inherent powers of each individual term in the bracket - in ((a)^2+(b^2)^2), pwrOfTerms = 3
    pwrOfTerms = 0,
